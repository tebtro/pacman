...
:: -opt:ref reduce segments size (-Fmwin32_pacman.map)
...
cl -Fe:%ExecutableName% %CommonCompilerFlags% %CompileTimeDefines% ..\src\win32_pacman.cpp -Fmwin32_pacman.map /link %AdditionalLinkerFlags% %Libraries%


:: 32-bit build
:: cl %CommonCompilerFlags% -subsystem:windows,5.1 %CompileTimeDefines% ..\src\win32_pacman.cpp /link %AdditionalLinkerFlags% %Libraries%


@echo.
ctime -end .\pacman_build.ctm %LastError%
